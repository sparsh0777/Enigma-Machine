...
#logo and title
image = PhotoImage(file="ENIGMA MACHINE.png")
Label(window, image=image, background='white').pack(padx=5, pady=5, side=TOP)


#frame
frame1 = Frame(window, borderwidth=0, relief=FLAT, background='gray')
...
#credits
_credits = Label(window, text = "Made by VIT CSE CORE'24", background='white')
